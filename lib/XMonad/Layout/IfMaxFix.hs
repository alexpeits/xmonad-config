...
-- Issue:
-- https://github.com/xmonad/xmonad-contrib/issues/75
-- Fix:
-- https://gist.github.com/f1u77y/58e286ec71b2692685b9ca4d24796bc4
...
instance (LayoutClass l1 Window, LayoutClass l2 Window) => LayoutClass (IfMax l1 l2) Window where
  ...
  description (IfMax n l1 l2) =
    "If number of windows is <= " ++ show n ++ ", then "
      ++ description l1
      ++ ", else "
      ++ description l2
